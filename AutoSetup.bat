...
if not exist "%VS_PROOT_DIR%\Win32\PlatformToolsets\LLVM8-vs2017" (mkdir "%VS_PROOT_DIR%\Win32\PlatformToolsets\LLVM8-vs2017")
copy Toolset-llvm-vs2017-x86.props "%VS_PROOT_DIR%\Win32\PlatformToolsets\LLVM8-vs2017\Toolset.props"
copy Toolset-llvm-vs2017-x86.targets "%VS_PROOT_DIR%\Win32\PlatformToolsets\LLVM8-vs2017\Toolset.targets"

if "%PROCESSOR_ARCHITECTURE%"=="AMD64" goto install_x64
if not "%PROCESSOR_ARCHITECTURE%"=="AMD64" goto done

:install_x64
if not exist "%VS_PROOT_DIR%\x64\PlatformToolsets\LLVM8-vs2017" (mkdir "%VS_PROOT_DIR%\x64\PlatformToolsets\LLVM8-vs2017")
copy Toolset-llvm-vs2017-x64.props "%VS_PROOT_DIR%\x64\PlatformToolsets\LLVM8-vs2017\Toolset.props"
copy Toolset-llvm-vs2017-x64.targets "%VS_PROOT_DIR%\x64\PlatformToolsets\LLVM8-vs2017\Toolset.targets"
goto done
